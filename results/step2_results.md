...
2. **Seeding fix**: the training seed was originally applied before the learning-rate
   ...
   search's random state. Correcting this (re-seeding immediately before the final training run) changed the baseline from 0.4570 to the current reported value of **0.5263**, and crucially, made genuine multi-seed variance measurement possible.
