...
def download_scifact():
    ...
    dataset = load_dataset("allenai/scifact", "claims",trust_remote_code=True, cache_dir=CACHE_DIR)
    ...
    corpus = load_dataset("allenai/scifact", "corpus", trust_remote_code=True, cache_dir=CACHE_DIR)
    ...
    labels = [ex["evidence_label"] for ex in dataset["train"]]
